...
export const ALL_EPISODES: StoryEpisode[] = [
  {
    ...
    coverArt: `${prefix}/images/cybo-rex/ep1-cover.jpg`,
    ...
    paragraphs: [
      ...
      `img:${prefix}/images/cybo-rex/luminar-city-bw.jpg|Luminar in the year 3000 — A Type III civilization powered by solar orbital rings and aerotransit networks.|LUMINAR 3000`,
      "---",
      ...
      `img:${prefix}/images/cybo-rex/secret-lab-bw.jpg|Dr. Victor Arclight's Classified Facility — Advanced weapons and temporal research deep beneath Luminar.|ARCLIGHT LAB`,
      "---",
      ...
      `img:${prefix}/images/cybo-rex/eclipsed-wilds-bw.jpg|The Eclipsed Wilds Incident — Research drones and scientists scan the impossible temporal void.|THE ANOMALY`,
      ...
      `img:${prefix}/images/cybo-rex/presidential-gala-bw.jpg|The Grand Presidential Gala — Officials and scientists gather under holographic displays amidst rising unease.|THE CELEBRATION`,
      "---",
      ...
      `img:${prefix}/images/cybo-rex/subterranean-corridor-bw.jpg|The Classified Descent — The President leads Dr. Arclight, Dr. Veyron, and intern John William Hardly into the subterranean bunker.|CLASSIFIED DESCENT`
    ],
